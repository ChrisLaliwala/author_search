...
@click.command(
    help="""
        Search for authors with keywords separated by spaces only. Pass up to 3 strings. 
        Adding more keywords will expand search (authors associated with any keyword will be considered in the search). 
